...
data = pd.read_csv('APPL Historical Data - APPL - Stock Prices (1).csv')
...
data = data.tail(300).reset_index(drop=True)
...
plt.title('Stock Closing Price Regression and Future Predictions (Last 100 Days)')
plt.legend()
plt.show()
